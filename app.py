...
def valid_add_employe():
    if request.method == "POST":
        ...
        tup_employe = (form.get('nomEmploye'), form.get('villeDept'), form.get('dateEmbauche'), form.get('indice'), form.get('salaire'), form.get('photo'), form.get('departement_id'))
...
def valid_edit_employe():
    ...
    if request.method == "POST":
        ...
        sql = ''' UPDATE employe 
                ...
                WHERE id_employe = %s  '''
        tup_departement_edit = (form.get('nomEmploye'), form.get('villeDept'), form.get('dateEmbauche'), form.get('indice'), form.get('salaire'), form.get('photo'), form.get('departement_id'), form.get('id'))
        cursor.execute(sql, tup_departement_edit)
        get_db().commit() 
